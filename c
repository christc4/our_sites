...
fn sbar {
	...
	BEGIN {
		lNF = 2
		print "<style>nav li ul{padding-left:.5em}body{display:flex;flex-wrap:wrap;margin:0 26%}article{flex:1}nav{min-width:12em}nav ul{border-bottom:1px solid;}ul{list-style: none}a:hover{color: red}</style><meta charset=utf-8><nav><ul>"
	}
